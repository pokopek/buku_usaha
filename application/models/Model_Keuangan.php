...
class Model_Keuangan extends CI_Model
{
    ...
    {
        $query = "SELECT SUM(total_beli) as total_beli, SUM(unit) as unit , tanggal_beli, produk_name, satuan FROM pembelian WHERE user_id = $id && MONTH(tanggal_beli) = $bulan && YEAR(tanggal_beli) = $tahun 
